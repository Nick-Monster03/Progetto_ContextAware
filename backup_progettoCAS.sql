...
\restrict mviYb5KMiHEA2UrrBQggMGbSsfdaBzRBIC441HmVwwjtItVbm9wZ3LgsdSPG9aS
...
ALTER SEQUENCE public.agenda_utente_id_seq OWNER TO postgres;
...
CREATE TABLE public.categoria_poi (
    ...
    CONSTRAINT categoria_poi_nome_check CHECK (((nome)::text = ANY ((ARRAY['biblioteca'::character varying, 'sala_studio'::character varying, 'mensa'::character varying, 'ufficio'::character varying, 'segreteria'::character varying, 'fermata'::character varying, 'noleggio_bici'::character varying, 'stazione'::character varying, 'benzinaio'::character varying])::text[])))
);
...
ALTER SEQUENCE public.categoria_poi_id_seq OWNER TO postgres;
...
CREATE TABLE public.evento (
    ...
    CONSTRAINT evento_feedback_check CHECK (((feedback)::text = ANY ((ARRAY['Utile'::character varying, 'Non Utile'::character varying])::text[]))),
    CONSTRAINT evento_tipo_check CHECK (((tipo)::text = ANY ((ARRAY['Avviso_agenda'::character varying, 'Suggerimento'::character varying, 'poi_selezionato'::character varying, 'geofencing_enter'::character varying, 'geofencing_exit'::character varying])::text[])))
);
...
ALTER SEQUENCE public.orario_poi_id_seq OWNER TO postgres;
...
CREATE TABLE public.utente (
    ...
    CONSTRAINT utente_mezzo_di_spostamento_check CHECK (((mezzo_di_spostamento)::text = ANY ((ARRAY['A PIEDI'::character varying, 'BICI A NOLEGGIO'::character varying, 'AUTOBUS'::character varying, 'TRENO'::character varying, 'MOTO'::character varying, 'AUTO'::character varying, 'ALTRO'::character varying])::text[])))
);
...
7	10	92	Esame CAS	2026-07-04 12:00:00+02	2026-07-04 14:00:00+02
8	10	100	Esame A.M.	2026-07-04 07:00:00+02	2026-07-04 09:00:00+02
9	10	101	Esame di fatti tuoi	2026-07-04 22:00:00+02	2026-07-05 00:00:00+02
10	10	240	SPeriamo fine	2026-07-06 08:00:00+02	2026-07-06 10:00:00+02
11	10	195	doccia	2026-07-04 19:00:00+02	2026-07-04 19:30:00+02
\.
...
156	Nippon Ramen	3	Cucina: japanese	0101000020E610000082D6B26B31B226401A3966344D3F4640	Bologna
...
1	Mario	Rossi	Bologna	A PIEDI	123
...
10	Nicola	Tinari	Bologna	A PIEDI	n1
\.
...
SELECT pg_catalog.setval('public.agenda_utente_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.evento_id_seq', 98, true);
...
\unrestrict mviYb5KMiHEA2UrrBQggMGbSsfdaBzRBIC441HmVwwjtItVbm9wZ3LgsdSPG9aS
