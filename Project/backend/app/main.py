...
from routers import utente_routers, poi_routers, categoria_routers, evento_routers, preferenza_routers, orari_routers, agenda_utente_routers, raccomandation_routers, geofence_routers, analytics_routers
